const services = [
  {
    ...
    en: "PAN Card",
    hi: "PAN Card",
    descEn: "New PAN and PAN-related assistance.",
    descHi: "नए PAN और PAN से संबंधित सहायता।"
  },
  {
    id: "voter",
    icon: "🗳️",
    en: "Voter ID Card",
    hi: "Voter ID Card",
    descEn: "Voter ID application assistance.",
    descHi: "Voter ID के लिए आवेदन सहायता।"
  },
  {
    id: "income",
    icon: "📄",
    ...
    descEn: "Income certificate application assistance.",
    descHi: "Income Certificate के लिए आवेदन सहायता।"
  },
  {
    id: "domicile",
    icon: "🏠",
    en: "Domicile Certificate",
    hi: "Domicile Certificate",
    descEn: "Domicile certificate application assistance.",
    descHi: "Domicile Certificate के लिए आवेदन सहायता।"
  },
  {
    id: "gumasta",
    icon: "🏪",
    en: "Gumasta Registration",
    hi: "Gumasta Registration",
    descEn: "Shop and business registration assistance.",
    descHi: "Shop और business registration की सहायता।"
  },
  {
    id: "fssai",
    icon: "🍽️",
    en: "Food Licence (FSSAI)",
    hi: "Food Licence (FSSAI)",
    descEn: "FSSAI registration and licence assistance.",
    descHi: "FSSAI registration और licence की सहायता।"
  },
  {
    id: "udyam",
    icon: "🏢",
    en: "Udyam Registration",
    hi: "Udyam Registration",
    descEn: "Udyam/MSME registration assistance.",
    descHi: "Udyam/MSME registration की सहायता।"
  },
  {
    id: "passport",
    icon: "🛂",
    en: "Passport Assistance",
    hi: "Passport Assistance",
    descEn: "Passport application assistance.",
    descHi: "Passport application की सहायता।"
  },
  {
    id: "itr",
    icon: "💼",
    en: "ITR Filing",
    hi: "ITR Filing",
    descEn: "Income Tax Return filing assistance.",
    descHi: "Income Tax Return filing की सहायता।"
  },
  {
    id: "gst",
    icon: "📑",
    en: "GST Registration",
    hi: "GST Registration",
    descEn: "GST registration assistance for businesses.",
    descHi: "Business के लिए GST registration की सहायता।"
  }
];
...
const i18n = {
  en: {
    ...
    continue_whatsapp: "Connect on WhatsApp"
  },
  ...
  hi: {
    ...
    continue_whatsapp: "WhatsApp से जुड़ें"
  }
};
...
function renderServices() {
  ...
  document.querySelectorAll(".apply-btn").forEach(button => {
    button.addEventListener("click", () => connectWhatsApp(button.dataset.id));
  });
}
...
function connectWhatsApp(id) {
  selected = services.find(service => service.id === id);

  if (!selected) return;

  const serviceName = selected.en;

  const message =
    `Hello DocSeva,%0A%0A` +
    `I want information about: ${encodeURIComponent(serviceName)}%0A%0A` +
    `Please guide me regarding the required documents, process and charges.`;
